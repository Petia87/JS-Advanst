...
describe('Main Object', function(){
    ...
    it('Add 5 tests undef', () => {
        expect(mathEnforcer.addFive('Petia')).to.be.undefined;
    });
    ...
    it('subtractTen tests undef', () => {
        expect(mathEnforcer.subtractTen('Petia')).to.be.undefined;
    });
    ...
    //sum
    it('Sum tests undef', () => {
        expect(mathEnforcer.sum('Petia',1)).to.be.undefined;
    });
    it('Sum tests undef', () => {
        expect(mathEnforcer.sum(2,'Petia')).to.be.undefined;
    });
    it('Sum tests undef invalid number of params', () => {
        expect(mathEnforcer.sum(2,'Petia',1)).to.be.undefined;
    });
